...
4. **New tools** — follow the tool interface in `internal/tools/`
5. **Documentation** — clarity, accuracy, examples

> **Note on skills:** Overkill skills are loaded from the filesystem, not from the repo.
> To share or discover skills, use [Clawhub](https://clawhub.com) or similar community hubs.
> Skill PRs to this repo will not be accepted.

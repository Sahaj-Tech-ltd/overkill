    ...
    },
    {
      ...
      action: () => {
        ...
        ctx.backend
          ...
          .catch((err: unknown) => { console.error("config.theme (dark) failed:", err); });
      },
    },
    {
      id: "theme-light",
      ...
      action: () => {
        ...
        ctx.backend
          ...
          .catch((err: unknown) => { console.error("config.theme (light) failed:", err); });
      },
    },
    {
      id: "theme-cyberpunk",
      ...
      action: () => {
        ...
        ctx.backend
          ...
          .catch((err: unknown) => { console.error("config.theme (cyberpunk) failed:", err); });
      },
    },
    {
      id: "theme-ocean",
      ...
      action: () => {
        ...
        ctx.backend
          ...
          .catch((err: unknown) => { console.error("config.theme (ocean) failed:", err); });
      },
    },
  ];
}

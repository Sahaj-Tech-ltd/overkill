...
function elephantArt(frame: number, color: string, compact: boolean): string[] {
  const { theme } = useTheme();
  const frames = compact ? [COMPACT_ELEPHANT] : ELEPHANT_FRAMES;
...
export function MemoBanner({
  ...
  const titleColor =
    phraseInfo.category === "contextual" ? theme.accent : theme.warning;

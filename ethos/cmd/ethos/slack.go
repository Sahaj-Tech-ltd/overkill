...
import (
	...
	slackpkg "github.com/Sahaj-Tech-ltd/ethos/internal/slack"
)
...
var slackCmd = &cobra.Command{
	Use:   "slack",
	Short: "Run the Ethos Slack bot daemon",
	Long: `Connect ethos to a Slack workspace using Socket Mode.
...
func runSlack(cmd *cobra.Command, args []string) error {
	...
	if appToken == "" || botToken == "" {
		fmt.Fprintln(os.Stderr, "ethos slack: missing tokens")
	...
	if home, err := os.UserHomeDir(); err == nil {
		sessionsPath = filepath.Join(home, ".ethos", "slack-sessions.json")
	}

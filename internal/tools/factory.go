...
func NewDefaultRegistry(deps FactoryDeps) *Registry {
	...
	register(NewShellTool(func(s *ShellTool) { s.defaultWorkingDir = deps.CWD }))
	...
	// Spider Test tools removed — TestAgentRunner never implemented, dead code.

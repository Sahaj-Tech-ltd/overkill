...
type CronLister interface {
	LoadJobs(ctx context.Context) ([]cron.Job, error)
}
...
func (t *CronListTool) Execute(ctx context.Context, in json.RawMessage) (json.RawMessage, error) {
	if t.store == nil {

...
func (t *CreateGoalTool) Execute(ctx context.Context, in json.RawMessage) (json.RawMessage, error) {
	if t.q == nil {
	...
	if err := t.q.SetWithBudgets(ctx, "", req.Objective, req.TokenBudget, 0); err != nil {
...
func (t *GetGoalTool) Execute(ctx context.Context, _ json.RawMessage) (json.RawMessage, error) {
	if t.q == nil {
		return errorJSON("goal store not configured"), nil
	}
	g, err := t.q.Get(ctx, "")
...
func (t *UpdateGoalTool) Execute(ctx context.Context, in json.RawMessage) (json.RawMessage, error) {
	if t.q == nil {
		return errorJSON("goal store not configured"), nil
	}
	...
	if err := t.q.SetStatus(ctx, "", req.Status); err != nil {
		return errorJSON(err.Error()), nil
	}
	g, err := t.q.Get(ctx, "")
	if err != nil {

// Package memory — semantic + episodic memory orchestration (Go side).
// Delegates embeddings + vector search to the Python bridge when available.
// Wired via run.go boot sequence; Postgres-backed.
package memory

...
func NewAlertStore(dir string) *AlertStore {
	...
	// B002: periodic pruning of acknowledged alerts.
...
// backgroundPrune periodically removes acknowledged alerts older than retention.
// Runs every hour. B002: ensures cleanup even when no new alerts are created.
func (s *AlertStore) backgroundPrune(ctx context.Context) {
...
// Close cancels the background prune goroutine.

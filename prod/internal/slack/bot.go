// Deprecated: This package is the pre-gateway Slack bot implementation.
// It does NOT implement the gateway.Channel interface (gateway/types.go).
// The replacement is internal/gateway/slack/ — a full gateway bot that
// integrates with the dispatcher, hub, and cron notification system.
//
// This package is kept for reference only and will be removed in a future
// release. Nothing in the codebase imports it (verified 2025-05-28).
package slack
